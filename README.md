# Novalnet Payment Module for SAP Commerce Cloud OCC
...
Novalnet merchant account is required for using this Novalnet payment module for SAP Commerce Cloud OCC. The module is available for the version 2205 in the following languages: EN & DE. 
